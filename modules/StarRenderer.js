...
export class StarRenderer {
    ...
    getStarVisualParams(star) {
        ...
        try {
            const spectralGroup = this.visualPresets.grid[spectral];
            if (!spectralGroup) {
                return defaultParams;
            }
            return spectralGroup[lumClass] || spectralGroup.default || defaultParams;
        } catch (error) {
            console.warn('Falling back to default star parameters', error);
            return defaultParams;
        }
    }
